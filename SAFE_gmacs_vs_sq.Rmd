...
mod_names <- c("GMACS_rbar")
.MODELDIR = c("./19_snow_gmacs_rbar/")
...
Scenarios   <-c("19_sq_model","19_sq_model")
...
for(x in 1:length(M))
  lines(M[[x]]$recruits[1,]/10000~SurveyYrs[[1]][-length(SurveyYrs[[1]])],col=2,lty=x+1)
...
for(x in 1:length(M))
  lines(M[[x]]$recruits[2,]/10000~SurveyYrs[[1]][-length(SurveyYrs[[1]])],col=4,lty=x+1)
...
for(x in 1:length(M))
 lines((M[[x]]$recruits[1,]/10000)  /(M[[x]]$recruits[2,]/10000)~SurveyYrs[[1]][-length(SurveyYrs[[1]])],col=1,lty=x+1)
...
for(x in 1:length(M))
 lines(LengthBins[[x]],make_sum_1(M[[x]]$d3_pre_size_comps_14[2,]),lty=x+1,col=2); 
...
for(x in 1:length(M))
   lines(LengthBins[[x]],make_sum_1(M[[x]]$d3_pre_size_comps_14[1,]),lty=x+1,col=4); 
...
for(x in 1:length(M))
 lines(LengthBins[[x]],make_sum_1(M[[x]]$d3_pre_size_comps_15[2,]),lty=x+1,col=2); 
...
for(x in 1:length(M))
   lines(LengthBins[[x]],make_sum_1(M[[x]]$d3_pre_size_comps_15[1,]),lty=x+1,col=4); 
...
x<-1
 ...
 lines(LengthBins[[x]],make_sum_1(M[[1]]$d3_pre_size_comps_16[2,]),lty=2,col=2); 
...
x<-1
   ...
   lines(LengthBins[[x]],make_sum_1(M[[1]]$d3_pre_size_comps_16[1,]),lty=2,col=4); 
...
x<-1
 ...
 lines(LengthBins[[x]],make_sum_1(M[[1]]$d3_pre_size_comps_17[2,]),lty=2,col=2); 
...
x<-1
   ...
   lines(LengthBins[[x]],make_sum_1(M[[1]]$d3_pre_size_comps_17[1,]),lty=2,col=4); 
...
inPred[[x]]<-
  tmp<-rbind(M[[1]]$d3_pre_size_comps_6,M[[1]]$d3_pre_size_comps_7)

 tmp2<-rbind(M[[1]]$d3_pre_size_comps_10,M[[1]]$d3_pre_size_comps_11)
...
legend("topright",bty='n',lty=seq(1,length(M)+1),legend=ScenarioNames,col=c("blue",rep(1,length(M))))
for(x in 1:length(M))
lines(M[[x]]$ssb~SurveyYrs[[1]][-length(SurveyYrs[[1]])],lty=x+1)
mtext(side=2,"Mature biomass (1000t)",line=2.5)

abline(h=M[[1]]$spr_bmsy,lty=3)
abline(h=B35[[1]],col='blue',lty=3)
...
for(x in 2:length(ScenarioNames))
{
   PlotTab$MMB[x]<-M[[x-1]]$ssb[length(M[[x-1]]$ssb)]
   PlotTab$B35[x]<-M[[x-1]]$spr_bmsy
   PlotTab$F35[x]<-M[[x-1]]$sd_fmsy
   PlotTab$FOFL[x]<-M[[x-1]]$sd_fofl[1]
   PlotTab$OFL[x]<-M[[x-1]]$spr_cofl
   PlotTab$Status[x]<- PlotTab$MMB[x-1]/PlotTab$B35[x-1]
}
